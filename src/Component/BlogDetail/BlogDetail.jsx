      ...
      <div className="grid grid-cols-1 md:grid-cols-3 py-[42px] gap-8">
        ...
        <div className="w-full">
          ...
          <p className="text-primary font-plex-mono">
            Users can amplify their potential payouts using the platform's
            leverage system, which multiplies the potential payout but also the
            risk.Users can amplify their potential payouts using the platform's
            leverage system, which multiplies the potential payout but also the
            risk.
          </p>
        </div>
